...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=560845577273999371&permissions=8&scope=bot')
  .setDescription(`**
  Someone Added Me ✅
...
client.on('guildDelete', guild => {
     ...
     .setColor("GOLD")
     .setTitle('Click Here To The Add Bot .!')
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=560845577273999371&permissions=8&scope=bott')
  .setDescription(`**
  I Got Kicked :cry:
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
...
if (message.content.startsWith(prefix + 'trans')) {
  ...
  .setColor("#9B59B6")
  .addField(" ** :scales:سيرفر الدعم:scales:  **" , "  **https://discord.gg/tG2ztbw**")
...
client.on('message', async message => {
    let amount = 9999999999999999999999999;
